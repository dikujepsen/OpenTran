...
GaussianDerivates(unsigned Lp, unsigned Lq, unsigned dim,
		  ...
		  float * D1Ks__ijb_x, unsigned D1Ks__ijb_x_size,
		  unsigned * D1Ks__ijb_dimsI,
		  float * D2Ks__ijbg_x,  unsigned D2Ks__ijbg_x_size,
		  unsigned * D2Ks__ijbg_dimsI,
		  float * D3Ks__ijbgd_x, unsigned D3Ks__ijbgd_x_size,
		  unsigned * D3Ks__ijbgd_dimsI
		  )
{
#if 1
#pragma acc kernels loop copyin(p_a_i_x[0:p_a_i_rows*dim], \
  				q_a_i_x[0:q_a_i_rows*dim], \
				D1Ks__ijb_dimsI[0:2],		\
				D2Ks__ijbg_dimsI[0:3],		\
				D3Ks__ijbgd_dimsI[0:4],		\
				)				\
			 copyout(K__ij_x[0:Lp*Lq],		\
				 D1Ks__ijb_x[0:D1Ks__ijb_x_size],     \
				 D2Ks__ijbg_x[0:D2Ks__ijbg_x_size],   \
				 D3Ks__ijbgd_x[0:D3Ks__ijbgd_x_size], \
				 ) independent
#endif  
