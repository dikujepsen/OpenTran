...
#ifndef POISSONEQUATIONSOLVEROCLMPI_HPP
#define POISSONEQUATIONSOLVEROCLMPI_HPP
...
namespace sg {
  namespace pde {
     ...
     * @version $HEAD$
     */
    class PoissonEquationSolverOCLMPI : public EllipticPDESolver {
      private:
      ...
      public:
         ...
         */
        PoissonEquationSolverOCLMPI();

        /**
         * Std-Destructor of the solver
         */
        virtual ~PoissonEquationSolverOCLMPI();
