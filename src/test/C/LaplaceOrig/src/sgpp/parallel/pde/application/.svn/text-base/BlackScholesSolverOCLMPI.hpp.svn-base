...
#ifndef BLACKSCHOLESOCLMPISOLVER_HPP
#define BLACKSCHOLESOCLMPISOLVER_HPP
...
namespace sg {
  namespace finance {
     ...
     * @version $HEAD$
     */
    class BlackScholesSolverOCLMPI : public sg::pde::ParabolicPDESolver {
      protected:
      ...
      public:
         ...
         */
        BlackScholesSolverOCLMPI(bool useLogTransform = false, bool usePAT = false);

        /**
         * Std-Destructor of the solver
         */
        virtual ~BlackScholesSolverOCLMPI();
         ...
         * current instance of BlackScholesSolverOCLMPI
         *
