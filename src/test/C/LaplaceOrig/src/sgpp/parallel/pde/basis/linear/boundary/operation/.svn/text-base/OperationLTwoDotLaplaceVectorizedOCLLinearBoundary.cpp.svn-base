...
namespace sg {
  namespace parallel {
    ...
    double OperationLTwoDotLaplaceVectorizedOCLLinearBoundary::gradient_dirichlet(size_t i, size_t j, size_t dim) {
      double grad;
    ...
    double OperationLTwoDotLaplaceVectorizedOCLLinearBoundary::l2dot_dirichlet(size_t i, size_t j, size_t dim) {
...
#pragma omp for schedule(static,8)
    ...
    void OperationLTwoDotLaplaceVectorizedOCLLinearBoundary::SetTimestepCoeff(REAL newTimestepCoeff) {
      this->TimestepCoeff = newTimestepCoeff;
    }
    REAL OperationLTwoDotLaplaceVectorizedOCLLinearBoundary::GetTimestepCoeff() {
