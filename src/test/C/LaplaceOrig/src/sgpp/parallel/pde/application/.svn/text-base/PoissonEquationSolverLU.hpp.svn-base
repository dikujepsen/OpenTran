...
#ifndef POISSONEQUATIONSOLVERLU_HPP
#define POISSONEQUATIONSOLVERLU_HPP
...
namespace sg {
  namespace pde {
     ...
     * @version $HEAD$
     */
    class PoissonEquationSolverLU : public EllipticPDESolver {
      private:
      ...
      public:
         ...
         */
        PoissonEquationSolverLU();

        /**
         * Std-Destructor of the solver
         */
        virtual ~PoissonEquationSolverLU();
...
#endif /* POISSONEQUATIONSOLVERLU_HPP */
