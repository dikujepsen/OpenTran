...
#include <mpi.h>
#include "parallel/pde/application/PoissonEquationSolverOCLMPI.hpp"
#include "parallel/pde/algorithm/PoissonEquationEllipticPDESolverSystemDirichletOCLMPI.hpp"
#include "parallel/solver/sle/ConjugateGradientsOCLMPI.hpp"
...
namespace sg {
  namespace pde {
    ...
    PoissonEquationSolverOCLMPI::PoissonEquationSolverOCLMPI() : EllipticPDESolver() {
      this->bGridConstructed = false;
      this->myScreen = NULL;
    }

    PoissonEquationSolverOCLMPI::~PoissonEquationSolverOCLMPI() {
      if (this->myScreen != NULL) {
        delete this->myScreen;
      }
    }

    void PoissonEquationSolverOCLMPI::constructGrid(BoundingBox& BoundingBox, int level) {
    ...
    void PoissonEquationSolverOCLMPI::solvePDE(DataVector& alpha, DataVector& rhs, size_t maxCGIterations, double epsilonCG, bool verbose) {
      std::cout << " PoissonEquationSolverOCLMPI " << std::endl;
      int myrank, nproz;
      ...
      ConjugateGradientsOCLMPI* myCG = new ConjugateGradientsOCLMPI(maxCGIterations, epsilonCG);
      PoissonEquationEllipticPDESolverSystemDirichletOCLMPI* mySystem = new PoissonEquationEllipticPDESolverSystemDirichletOCLMPI(*(this->myGrid), rhs);
    ...
    void PoissonEquationSolverOCLMPI::initGridWithSmoothHeat(DataVector& alpha, double mu, double sigma, double factor) {
    ...
    void PoissonEquationSolverOCLMPI::initGridWithSmoothHeatFullDomain(DataVector& alpha, double mu, double sigma, double factor) {
      if (this->bGridConstructed) {
        double tmp;
        double* dblFuncValues = new double[this->dim];
    ...
    void PoissonEquationSolverOCLMPI::initGridWithExpHeat(DataVector& alpha, double factor) {
      if (this->bGridConstructed) {
        double tmp;
        double* dblFuncValues = new double[this->dim];
    ...
    void PoissonEquationSolverOCLMPI::initGridWithExpHeatFullDomain(DataVector& alpha, double factor) {
      if (this->bGridConstructed) {
        double tmp;
        double* dblFuncValues = new double[this->dim];
        double* rightBound = new double[this->dim];
    ...
    void PoissonEquationSolverOCLMPI::storeInnerMatrix(std::string tFilename) {
    ...
    void PoissonEquationSolverOCLMPI::storeInnerMatrixDiagonal(std::string tFilename) {
      DataVector rhs(this->myGrid->getSize());
      rhs.setAll(0.0);
      PoissonEquationEllipticPDESolverSystemDirichletOCLMPI* mySystem = new PoissonEquationEllipticPDESolverSystemDirichletOCLMPI(*(this->myGrid), rhs);
      SGppStopwatch* myStopwatch = new SGppStopwatch();
    ...
    void PoissonEquationSolverOCLMPI::storeInnerMatrixDiagonalRowSum(std::string tFilename) {
      DataVector rhs(this->myGrid->getSize());
      rhs.setAll(0.0);
      PoissonEquationEllipticPDESolverSystemDirichletOCLMPI* mySystem = new PoissonEquationEllipticPDESolverSystemDirichletOCLMPI(*(this->myGrid), rhs);
      SGppStopwatch* myStopwatch = new SGppStopwatch();
    ...
    void PoissonEquationSolverOCLMPI::storeInnerRHS(DataVector& alpha, std::string tFilename) {
      SGppStopwatch* myStopwatch = new SGppStopwatch();
      PoissonEquationEllipticPDESolverSystemDirichletOCLMPI* mySystem = new PoissonEquationEllipticPDESolverSystemDirichletOCLMPI(*(this->myGrid), alpha);
    ...
    void PoissonEquationSolverOCLMPI::storeInnerSolution(DataVector& alpha, size_t maxCGIterations, double epsilonCG, std::string tFilename) {
      ConjugateGradientsOCLMPI* myCG = new ConjugateGradientsOCLMPI(maxCGIterations, epsilonCG);
      PoissonEquationEllipticPDESolverSystemDirichletOCLMPI* mySystem = new PoissonEquationEllipticPDESolverSystemDirichletOCLMPI(*(this->myGrid), alpha);
    ...
    void PoissonEquationSolverOCLMPI::initScreen() {
