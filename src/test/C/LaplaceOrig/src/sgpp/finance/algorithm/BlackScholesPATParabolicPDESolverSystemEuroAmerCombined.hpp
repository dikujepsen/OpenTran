...
namespace sg {
  namespace finance {
     ...
     */
    class BlackScholesPATParabolicPDESolverSystemEuroAmer : public sg::pde::OperationParabolicPDESolverSystemDirichletCombined {
    protected:
...
#endif /* BLACKSCHOLESPATPARABOLICPDESOLVERSYSTEMEUROAMERCOMBINED_HPP */
