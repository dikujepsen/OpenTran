...
int main(int argc, char* argv[]) {
  ...
  if (lmb == 1) {
    ...
    vect = sg::op_factory::createOperationLaplaceVectorized(*myGrid, lambda, sg::parallel::OpenCL);
  } else {
    updown = sg::op_factory::createOperationLaplace(*myGrid);
    vect = sg::op_factory::createOperationLaplaceVectorized(*myGrid, sg::parallel::OpenCL);
  }
