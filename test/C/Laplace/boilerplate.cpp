...
void AllocateBuffers()
{
  ...
  cout << "hst_ptrindex_mem_size: " << hst_ptrindex_mem_size/8 << endl;
  cout << "hst_ptrlevel_int_mem_size: " << hst_ptrlevel_int_mem_size/8 << endl;
  cout << "hst_ptrlevel_mem_size: " << hst_ptrlevel_mem_size/8 << endl;
  cout << "hst_ptrlcl_q_mem_size: " << hst_ptrlcl_q_mem_size/8  << endl;
  cout << "hst_ptrresult_mem_size: " << hst_ptrresult_mem_size/8 << endl;
  cout << "hst_ptrlcl_q_inv_mem_size: " << hst_ptrlcl_q_inv_mem_size/8 << endl;
  cout << "hst_ptralpha_mem_size: " << hst_ptralpha_mem_size/8 << endl;
  cout << "hst_ptrlambda_mem_size: " << hst_ptrlambda_mem_size/8 << endl;
...
void ExecLaplaceFor()
{
  ...
  size_t LaplaceFor_local_worksize[] = {128};
