...
std::string KernelString()
{
  ...
  str << "          float level_j = level[(d * hst_ptrlevel_dim1) + j];" << endl;
  str << "          float level_int_i = level_int_reg[d];" << endl;
  str << "          float level_int_j = level_int[(d * hst_ptrlevel_int_dim1) + j];" << endl;
  str << "          float index_i = index_reg[d];" << endl;
  str << "          float index_j = index[(d * hst_ptrindex_dim1) + j];" << endl;
  ...
  str << "	lcl_q[d]);" << endl;
  str << "      }" << endl;
  str << "      float alphatemp = alpha[j];" << endl;
