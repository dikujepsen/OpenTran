...
int main(int argc, char* argv[]) {
  ...
  updown = sg::op_factory::createOperationLTwoDotProduct(*myGrid);
  vect = sg::op_factory::createOperationLTwoDotProductVectorized(*myGrid, sg::parallel::OpenCL);

  std::cout << std::endl;
  std::cout << "L2Dot Test Application" << std::endl;
