...
namespace sg {
  namespace pde {
     ...
     */
    class OperationParabolicPDESolverSystemDirichletCombined : public OperationParabolicPDESolverSystem {
    protected:
