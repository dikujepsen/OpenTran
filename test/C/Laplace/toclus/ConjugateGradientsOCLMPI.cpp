...
namespace sg {
  namespace solver {
    ...
    ConjugateGradientsOCLMPI::ConjugateGradientsOCLMPI(size_t imax, double epsilon) : SLESolver(imax, epsilon) {
      std::cout << "ConjugateGradientsOCLMPI " << std::endl;
    }

    ConjugateGradientsOCLMPI::~ConjugateGradientsOCLMPI() {
    }

    void ConjugateGradientsOCLMPI::solve(sg::base::OperationMatrix& SystemMatrix, sg::base::DataVector& alpha, sg::base::DataVector& b, bool reuse, bool verbose, double max_threshold) {
    ...
    void ConjugateGradientsOCLMPI::starting() {
    }

    void ConjugateGradientsOCLMPI::calcStarting() {
    }

    void ConjugateGradientsOCLMPI::iterationComplete() {
    }

    void ConjugateGradientsOCLMPI::complete() {
    }
