...
#ifndef CONJUGATEGRADIENTSOCLMPI_HPP
#define CONJUGATEGRADIENTSOCLMPI_HPP
...
namespace sg {
  namespace solver {
    ...
    class ConjugateGradientsOCLMPI : public SLESolver {
      public:
        /**
         * Std-Constructor
         */
        ConjugateGradientsOCLMPI(size_t imax, double epsilon);

        /**
         * Std-Destructor
         */
        virtual ~ConjugateGradientsOCLMPI();
