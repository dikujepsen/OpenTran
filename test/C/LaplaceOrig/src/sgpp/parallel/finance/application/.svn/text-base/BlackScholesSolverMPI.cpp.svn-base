...
namespace sg {
  namespace parallel {
    ...
    void BlackScholesSolverMPI::setEnableCoarseningData(std::string adaptSolveMode, std::string refineMode, int refineMaxLevel, int numCoarsenPoints, double coarsenThreshold, double refineThreshold) {
    ...
    void BlackScholesSolverMPI::initLogTransformedGridWithPayoff(base::DataVector& alpha, double strike, std::string payoffType) {
      double tmp;
    ...
    void BlackScholesSolverMPI::initPATTransformedGridWithPayoff(base::DataVector& alpha, double strike, std::string payoffType) {
      double tmp;
