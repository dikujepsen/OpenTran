...
#include "../sgpp/parallel/pde/application/BlackScholesSolverOCLMPI.hpp"
#include <iostream>
#include <string>
#include <stdlib.h>
#include <fstream>
...
/**
 * Calls the writeHelp method in the BlackScholesSolverOCLMPI Object
 * after creating a screen.
 */
void writeHelp() {
  sg::finance::BlackScholesSolverOCLMPI* myBSSolver = new sg::finance::BlackScholesSolverOCLMPI();
...
void testNUnderlyings(size_t d, size_t l, std::string fileStoch, std::string fileBound, double dStrike, std::string payoffType,
  ...
  sg::finance::BlackScholesSolverOCLMPI* myBSSolver;
  myBSSolver = NULL;

  if (coordsType == "log") {
    myBSSolver = new sg::finance::BlackScholesSolverOCLMPI(true);
  } else if (coordsType == "cart") {
    myBSSolver = new sg::finance::BlackScholesSolverOCLMPI(false);
  } else if (coordsType == "PAT") {
    myBSSolver = new sg::finance::BlackScholesSolverOCLMPI(true, true);
  } else {
    // Write Error
...
void testNUnderlyingsAnalyze(size_t d, size_t start_l, size_t end_l, std::string fileStoch, std::string fileBound, double dStrike, std::string payoffType,
  ...
  std::cout << " testNUnderlyingsAnalyze " << std::endl;
...
void testNUnderlyingsAnalyzeTimeStepping(size_t d, size_t start_l, size_t end_l, std::string fileStoch, std::string fileBound, double dStrike, std::string payoffType,
  ...
  std::cout << " testNUnderlyingsAnalyzeTimeStepping " << std::endl;
  ...
  if (isLogSolve == true) {
    myBSSolver = new sg::finance::BlackScholesSolverOCLMPI(true, "European");
  } else {
    myBSSolver = new sg::finance::BlackScholesSolverOCLMPI(false, "European");
  }
...
void test1UnderlyingAnalyze(size_t start_l, size_t end_l, std::string fileStoch, std::string fileBound, double dStrike, std::string payoffType,
  ...
  std::cout << " test1UnderlyingAnalyze " << std::endl;
